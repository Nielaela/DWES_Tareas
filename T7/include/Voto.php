<?php
/**Clase Voto, conecta a la BD para realizar varias funciones en ella
 * Validar si el voto ya existia por un usuario
 * Inserccion de votos mediante una query
 * pintarEstrellas con una serie de consultas realiza el promedio de la calificacion de cada producto
 */
