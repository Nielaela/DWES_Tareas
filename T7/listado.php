<?php
/**Pagina donde se mostrará el listado con los productos y votos, al igual que login.php se utilizará
 * el script 2validar.js" para utilizar las funciones XAJAX que se definiceron en "funcionesVotos.php"
 * 
 */
session_start();
...
$xajax =  new xajax('include/FuncionesVotos.php');
