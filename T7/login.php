<?php
/**Inicio de la pagina, se validará desde cliente von el script "validar.js" y las funciones ya definidas de XAJAX
 * en Validar.php de validacion de usuario
 */
//control error deprecated
